...
export const projects: Project[] = [
  ...
  {
    slug: "marriage-hall-booking-system",
    number: "03",
    title: "Marriage Hall Booking & Management System (SaaS)",
    headline: "Multi-tenant booking SaaS for hall owners and customers with real-time availability workflows.",
    description:
      "A full-stack SaaS platform for real-world hall booking operations, enabling owners to manage schedules and customers to check availability and reserve halls online. Built with secure authentication, role-based flows, and real-time database updates, it demonstrates production-grade architecture for scalable business applications.",
    intro:
      "This project is designed as a practical multi-tenant business system where each hall owner can manage inventory, bookings, and customer activity from a dedicated dashboard. End users can browse availability, book halls, and track requests through a responsive experience built for real usage.",
    features: [
      "Multi-tenant architecture that separates owner data and booking operations by account.",
      "Real-time booking and availability management powered by Prisma ORM and database sync.",
      "Secure authentication with dedicated owner and user flows for role-specific actions.",
      "Mobile-responsive dashboard and booking UI optimized for real customer interactions.",
    ],
    tags: ["Next.js", "TypeScript", "React", "Prisma ORM", "Tailwind CSS"],
    liveUrl: "https://marraige-hall-booking-system-sooty.vercel.app/",
    displayUrl: "marraige-hall-booking-system-sooty.vercel.app",
    images: ["/images/project 3.png", "/images/project 3a.png", "/images/project 3b.png"],
    timeline: "2025",
    role: "Full-Stack SaaS Engineering + Product Architecture",
    outcome:
      "The platform validates expertise in building scalable business software with secure access control, reliable booking logic, and production-ready full-stack execution.",
    testCredentials: {
      gmail: "zaifimalik2001@gmail.com",
      password: "12345678",
    },
  },
];
